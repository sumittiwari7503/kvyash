...
function ContactForm() {
 ...
 contactMode === "chat"
 ? "bg-white text-brand-500 shadow-sm border border-slate-200/20 "
 ...
 className={`text-sm bg-slate-50 border rounded-lg px-4 py-3 text-slate-850 placeholder-slate-400 focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 focus:bg-white transition-premium ${
 ...
 className="text-sm bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 text-slate-850 placeholder-slate-400 focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 focus:bg-white transition-premium"
 />
 </div>
 ...
 className={`text-sm bg-slate-50 border rounded-lg px-4 py-3 text-slate-850 placeholder-slate-400 focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 focus:bg-white transition-premium resize-none ${
 ...
 <span className="">{companyData.location}</span>
 </div>
 </div>
 ...
 <h4 className="text-sm font-bold text-navy-900 uppercase tracking-widest border-b border-slate-100 pb-2">Scoping FAQ</h4>
 {faqs.map((faq) => (
 <div key={faq.q} className="space-y-1.5 border-b border-slate-50 last:border-0 pb-4 last:pb-0">
 <h5 className="font-bold text-navy-900 text-sm">{faq.q}</h5>
 <p className="text-slate-650 text-xs leading-relaxed">{faq.a}</p>
 </div>
 ))}
 </div>
