...
export default function WorkPage() {
  return (
    <div className="font-sans text-navy-900 bg-white">
      ...
      <section className="py-20 bg-white dark:bg-[#090d16] border-b border-slate-100 dark:border-slate-800/80">
      ...
      <section className="py-20 bg-slate-50 dark:bg-[#0c1321]/50 border-b border-slate-100 dark:border-slate-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 text-center">
            {[
              ...
              <div
                key={system}
                className="bg-white dark:bg-[#0d1321] border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm flex flex-col justify-between items-center relative"
              >
                <div className="space-y-2">
                  <span className="inline-block text-[8px] font-bold bg-slate-100 dark:bg-slate-900 text-slate-500 dark:text-slate-450 px-1.5 py-0.5 rounded uppercase">
                    Capability
                  </span>
                  <h4 className="text-navy-900 dark:text-slate-200 font-extrabold text-xs sm:text-sm">{system}</h4>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-white dark:bg-[#090d16] border-b border-slate-100 dark:border-slate-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-slate-50 dark:bg-[#0d1321] border border-slate-200/60 dark:border-slate-800 rounded-xl p-6 shadow-sm">
              <h4 className="text-base font-bold text-navy-900 dark:text-slate-100 mb-3 border-b border-slate-200 dark:border-slate-800 pb-2">1. Fixed Scope Blueprints</h4>
            ...
            <div className="bg-slate-50 dark:bg-[#0d1321] border border-slate-200/60 dark:border-slate-800 rounded-xl p-6 shadow-sm">
              <h4 className="text-base font-bold text-navy-900 dark:text-slate-100 mb-3 border-b border-slate-200 dark:border-slate-800 pb-2">2. Direct Dev Access</h4>
              <p className="text-slate-600 dark:text-slate-400 text-xs leading-relaxed">
            ...
            <div className="bg-slate-50 dark:bg-[#0d1321] border border-slate-200/60 dark:border-slate-800 rounded-xl p-6 shadow-sm">
              <h4 className="text-base font-bold text-navy-900 dark:text-slate-100 mb-3 border-b border-slate-200 dark:border-slate-800 pb-2">3. Transferable Ownership</h4>
              <p className="text-slate-600 dark:text-slate-400 text-xs leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-[#0d1321] border border-slate-200 dark:border-slate-800 rounded-xl p-8 sm:p-12 shadow-sm text-center flex flex-col gap-6 items-center">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3">
              ...
              <Link
                href="/contact"
                className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 rounded border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 text-navy-900 dark:text-slate-200 font-semibold hover:bg-slate-50 dark:hover:bg-slate-900 transition-premium text-center cursor-pointer"
              >
                Talk to KVYASH
              </Link>
            </div>
