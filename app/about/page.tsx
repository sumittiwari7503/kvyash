...
export default function AboutPage() {
 ...
 <section id="approach" className="py-20 md:py-28 bg-white border-b border-slate-100 reveal-on-scroll">
 ...
 <div
 key={val.title}
 className="bg-slate-50 border border-slate-100 rounded-xl p-6 shadow-premium hover:shadow-premium-hover transition-premium duration-300 flex flex-col justify-between reveal-on-scroll hover:-translate-y-0.5"
 style={{ transitionDelay: `${idx * 100}ms` }}
 >
 <div>
 <h4 className="text-base font-bold text-navy-900 mb-4 border-b border-slate-200 pb-3">{val.title}</h4>
 <p className="text-slate-655 text-xs leading-relaxed">{val.desc}</p>
 </div>
 </div>
 ))}
 </div>
