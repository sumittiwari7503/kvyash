...
const capabilities = [
  ...
  },
  {
    ...
    points: [
      "Prerendered static HTML cached geographically across Edge CDNs",
...
const lifecycleSteps = [
  ...
  {
    number: "06",
    title: "Edge Deployment & DNS Setup",
...
const targetAudiences = [
  ...
  },
  {
    ...
    desc: "Businesses transitioning outdated, slow web applications into modern Next.js and React web architectures deployed with global edge caching."
  }
];
...
export default function WebDevelopmentPage() {
  return (
    <div className="font-sans text-navy-900 bg-white transition-colors duration-300">
      ...
      <section className="bg-slate-50 border-b border-slate-100 pt-36 pb-20 md:pt-40 md:pb-28 relative overflow-hidden reveal-on-scroll">
        <div className="absolute inset-0 opacity-[0.03] bg-[radial-gradient(#2563eb_1px,transparent_1px)] [background-size:16px_16px] pointer-events-none"></div>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col gap-6 relative z-10">
          <span className="inline-flex self-center items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-semibold bg-brand-50 text-brand-600 border border-brand-100 uppercase tracking-wide">
          ...
          <p className="text-slate-600 text-base sm:text-lg lg:text-xl max-w-3xl mx-auto leading-relaxed">
            We engineer high-performance business websites, bespoke web applications, customer portals, and internal operations tools. Built with Next.js, React, TypeScript, and scalable relational databases—delivered with clean architecture, edge caching performance, and repository handover under agreed terms.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <StartProjectButton
              intent="BUILD_SOMETHING"
              className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3.5 bg-brand-500 hover:bg-brand-600 text-white text-sm font-bold rounded-lg transition-all duration-300 shadow-sm hover:shadow-md cursor-pointer group"
            >
            ...
            <Link
              href="/work"
              className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3.5 bg-white hover:bg-slate-50 text-slate-700 text-sm font-semibold rounded-lg border border-slate-200 hover:border-slate-300 transition-all duration-300 shadow-sm text-center"
            >
      ...
      <section className="py-20 md:py-28 bg-white border-b border-slate-100 reveal-on-scroll">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-3">
            <span className="text-xs font-bold uppercase tracking-widest text-brand-500">Solutions Portfolio</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {whatWeBuild.map((item, idx) => {
              ...
              return (
                <div
                  key={item.title}
                  className={`bg-slate-50 border border-slate-200/70 rounded-2xl p-7 flex flex-col justify-between hover:border-brand-500/30 hover:bg-white hover:shadow-premium-hover hover:-translate-y-1 transition-all duration-300 ${
                    isLast ? "md:col-span-2 lg:col-span-1 lg:col-start-2" : ""
                  }`}
                >
                  <div className="flex flex-col gap-4">
                    <div className="inline-flex self-start items-center justify-center p-3 rounded-xl bg-white text-brand-500 shadow-sm border border-slate-100">
      ...
      <section className="py-20 md:py-28 bg-slate-50 border-b border-slate-100 reveal-on-scroll">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-3">
            <span className="text-xs font-bold uppercase tracking-widest text-brand-500">Architecture &amp; Quality</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-navy-900 tracking-tight">
              Engineering Capabilities
            </h2>
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              We apply software engineering principles to modern web development, focusing on maintainability, edge performance optimization, and relational data integrity.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {capabilities.map((cap) => {
              ...
              return (
                <div
                  key={cap.title}
                  className="bg-white border border-slate-200/80 rounded-2xl p-8 flex flex-col gap-5 shadow-sm hover:border-brand-500/20 hover:shadow-md transition-all duration-300"
                >
                  <div className="flex items-center gap-3.5">
                    <div className="p-2.5 rounded-lg bg-brand-50 text-brand-500 border border-brand-100">
                      <Icon className="h-5 w-5" aria-hidden="true" />
                    </div>
                    <h3 className="text-xl font-bold text-navy-900">{cap.title}</h3>
                  </div>
                  <ul className="space-y-3 pt-2">
                    {cap.points.map((pt) => (
                      <li key={pt} className="flex items-start gap-2.5 text-xs sm:text-sm text-slate-600 leading-relaxed">
      ...
      <section className="py-20 md:py-28 bg-white border-b border-slate-100 reveal-on-scroll">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-3">
            <span className="text-xs font-bold uppercase tracking-widest text-brand-500">Modern Technology Stack</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-navy-900 tracking-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {techStack.map((stack) => (
              <div
                key={stack.category}
                className="bg-slate-50 border border-slate-200/70 rounded-xl p-6 flex flex-col gap-4 shadow-sm"
              >
                <h3 className="text-xs font-bold uppercase tracking-wider text-brand-600">{stack.category}</h3>
                <ul className="space-y-2">
                  {stack.items.map((item) => (
                    <li key={item} className="text-xs sm:text-sm font-medium text-slate-700 flex items-center gap-2">
      ...
      <section className="py-20 md:py-28 bg-slate-50 border-b border-slate-100 reveal-on-scroll">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-3">
            <span className="text-xs font-bold uppercase tracking-widest text-brand-500">Our Methodology</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-navy-900 tracking-tight">
              7-Step Development Lifecycle
            </h2>
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              A transparent, milestone-driven engineering process from requirements scoping through edge deployment and handover.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {lifecycleSteps.map((step, idx) => {
              ...
              return (
                <div
                  key={step.number}
                  className={`bg-white border border-slate-200/70 rounded-2xl p-7 flex flex-col justify-between shadow-sm hover:border-slate-300 transition-all duration-300 ${
                    isLast ? "md:col-span-2 lg:col-span-1 lg:col-start-2" : ""
                  }`}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 flex flex-col gap-6">
              <span className="text-xs font-bold uppercase tracking-widest text-brand-500">Security &amp; Standards</span>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-navy-900 tracking-tight">
              ...
              <div className="space-y-4 pt-2">
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-navy-900">Code &amp; Deliverables Transfer</h3>
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-navy-900">Row-Level Security &amp; Data Isolation</h3>
                    <p className="text-slate-600 text-xs sm:text-sm mt-0.5 leading-relaxed">
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-navy-900">Edge Caching &amp; Core Web Vitals</h3>
                    <p className="text-slate-600 text-xs sm:text-sm mt-0.5 leading-relaxed">
            ...
            <div className="lg:col-span-6 bg-slate-50 border border-slate-200/80 rounded-2xl p-8 shadow-sm">
              <h3 className="text-lg font-bold text-navy-900 mb-4 flex items-center gap-2">
                <CheckCircle2 className="h-5 w-5 text-emerald-600" />
                Standard Engineering Checklist
              </h3>
              <ul className="space-y-3 text-xs sm:text-sm text-slate-655">
                <li className="flex items-center gap-2.5 pb-2.5 border-b border-slate-200/60">
      ...
      <section className="py-20 md:py-28 bg-slate-50 border-b border-slate-100 reveal-on-scroll">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-3">
            <span className="text-xs font-bold uppercase tracking-widest text-brand-500">Target Audiences</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-navy-900 tracking-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {targetAudiences.map((aud) => (
              <div
                key={aud.title}
                className="bg-white border border-slate-200/70 rounded-xl p-7 flex flex-col gap-3 shadow-sm hover:border-brand-500/20 transition-all duration-300"
              >
                <h3 className="text-lg font-bold text-navy-900">{aud.title}</h3>
                <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">{aud.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-white border-b border-slate-100 reveal-on-scroll">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-3">
            <span className="text-xs font-bold uppercase tracking-widest text-brand-500">Approach Comparison</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-navy-900 tracking-tight">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-8 flex flex-col justify-between">
              <div>
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider block mb-2">Basic Tools</span>
                <h3 className="text-xl font-bold text-navy-900 mb-4">Templates &amp; No-Code Builders</h3>
                <p className="text-slate-600 text-xs sm:text-sm leading-relaxed mb-4">
                  Effective for simple content blogs, temporary landing experiments, and early proof-of-concept prototypes with standard layout needs.
                </p>
            ...
            <div className="bg-brand-50/50 border border-brand-200/70 rounded-2xl p-8 flex flex-col justify-between">
              <div>
                <span className="text-xs font-bold text-brand-600 uppercase tracking-wider block mb-2">Engineered Solution</span>
                <h3 className="text-xl font-bold text-navy-900 mb-4">Custom Next.js &amp; React Engineering</h3>
                <p className="text-slate-600 text-xs sm:text-sm leading-relaxed mb-4">
                ...
                <ul className="space-y-2.5 text-xs text-slate-700">
                  <li className="flex items-center gap-2">
                    ...
                    <span>Optimized page rendering via Edge CDN caching</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-brand-500" />
      ...
      {/* 9. Verifiable Production Proof */}
      <section className="py-20 md:py-28 bg-slate-50 border-b border-slate-100 reveal-on-scroll">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white border border-slate-200/80 rounded-2xl p-8 md:p-10 shadow-sm flex flex-col lg:flex-row lg:items-center justify-between gap-8">
            <div className="flex flex-col gap-4 max-w-2xl">
              <span className="text-xs font-bold uppercase tracking-widest text-brand-500">Verifiable Technical Proof</span>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-navy-900 tracking-tight">
                Static Site Generation with Edge Revalidation
              </h2>
              <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
                Review our internal production Next.js architecture utilizing static page exports, dynamic edge caching policies, and optimized Largest Contentful Paint benchmarks. Explore our live <Link href="/work#case-studies" className="font-semibold text-brand-600 hover:underline">production case studies</Link>, explore <Link href="/solutions" className="font-semibold text-brand-600 hover:underline">B2B software consulting blueprints</Link>, or read our architectural guide on <Link href="/resources/custom-web-application-development" className="font-semibold text-brand-600 hover:underline">custom web application development</Link>.
              </p>
            </div>
            <div className="shrink-0 flex flex-col sm:flex-row lg:flex-col gap-3">
              <Link
                href="/work"
                className="inline-flex items-center justify-center px-5 py-3 bg-brand-500 hover:bg-brand-600 text-white text-xs font-bold rounded-lg transition-all duration-300 shadow-sm text-center"
              >
              ...
              <Link
                href="/services"
                className="inline-flex items-center justify-center px-5 py-3 bg-white hover:bg-slate-50 text-slate-700 text-xs font-semibold rounded-lg border border-slate-200 transition-all duration-300 text-center"
              >
                Services Overview
              </Link>
            </div>
      ...
      <section className="py-20 md:py-28 bg-white border-b border-slate-100 reveal-on-scroll">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-3">
            <span className="text-xs font-bold uppercase tracking-widest text-brand-500">Frequently Asked Questions</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-navy-900 tracking-tight">
              Web Development FAQ
            </h2>
          ...
          <div className="space-y-6">
            {faqs.map((faq) => (
              <div
                key={faq.q}
                className="bg-slate-50 border border-slate-200/70 rounded-xl p-6 transition-all duration-300 hover:border-slate-300"
              >
                <h3 className="text-base font-bold text-navy-900 mb-2.5 flex items-start gap-2.5">
                  <HelpCircle className="h-5 w-5 text-brand-500 shrink-0 mt-0.5" />
                  <span>{faq.q}</span>
                </h3>
                <p className="text-slate-655 text-xs sm:text-sm leading-relaxed pl-7.5">{faq.a}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-slate-50 relative overflow-hidden reveal-on-scroll">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col gap-6 relative z-10">
          <span className="inline-flex self-center items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-brand-50 text-brand-600 border border-brand-100 uppercase tracking-wide">
            Start A Project
          </span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            ...
            <Link
              href="/contact"
              className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3.5 bg-white hover:bg-slate-50 text-slate-700 text-sm font-semibold rounded-lg border border-slate-200 transition-all duration-300 shadow-sm text-center"
            >
              Contact Engineering Team
            </Link>
          </div>
          <p className="text-xs text-slate-500 pt-2">
            Serving businesses across Greater Noida, Noida, Delhi NCR, and international teams. Also explore our <Link href="/ai-automation" className="text-brand-600 hover:underline">AI automation services</Link> and <Link href="/services" className="text-brand-600 hover:underline">full service directory</Link>.
          </p>
        </div>
      </section>
    </div>
