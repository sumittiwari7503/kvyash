...
export default function RootLayout({
  ...
  return (
    ...
    >
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('kvyash-theme');if(t==='dark'||(!t&&window.matchMedia('(prefers-color-scheme: dark)').matches)){document.documentElement.classList.add('dark')}else{document.documentElement.classList.remove('dark')}}catch(e){}})();`,
          }}
        />
        <script
      ...
      <body className="min-h-full flex flex-col bg-slate-50 dark:bg-slate-950 text-navy-900 dark:text-slate-100 antialiased transition-colors duration-300">
