      ...
      <section className="py-24 bg-slate-50 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-white border border-slate-100 rounded-xl p-8 shadow-premium flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-4 relative">
                <div className="bg-slate-50 border border-slate-200 rounded p-4 text-xs text-slate-500">
                  <span className="font-semibold text-navy-900 block mb-1">Step 1: Document Upload</span>
                ...
                <div className="bg-slate-50 border border-slate-200 rounded p-4 text-xs text-slate-500 ml-4 border-l-brand-500 border-l-4">
                  <span className="font-semibold text-navy-900 block mb-1">Step 2: LLM Classification</span>
