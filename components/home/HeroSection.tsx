      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 text-center lg:text-left">
            ...
            >
              <StartProjectButton
                className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3.5 bg-brand-500 hover:bg-brand-600 text-white font-semibold rounded active:scale-[0.98] transition-all shadow-lg shadow-brand-500/20 cursor-pointer text-center text-sm"
              >
                Start a Project
