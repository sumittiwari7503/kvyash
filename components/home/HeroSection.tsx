...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(37,99,235,0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(37,99,235,0.05)_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_40%,#000_60%,transparent_100%)] opacity-40 animate-grid-flow" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 text-center lg:text-left">
            <span 
              className="inline-flex self-center lg:self-start items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-brand-500/10 text-brand-500 border border-brand-500/20 uppercase tracking-widest transition-all duration-700 ease-out"
              style={{
                opacity: mounted ? 1 : 0,
            ...
            <h1 
              className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-navy-900 leading-tight font-sans"
              style={{
                opacity: mounted ? 1 : 0,
            ...
            >
              ...
              and <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-600 to-brand-500">AI automation</span>.
            </h1>
            ...
            <div 
              ...
              style={{
                ...
                transition: "opacity 0.8s cubic-bezier(0.16, 1, 0.3, 1) 450ms, transform 0.8s cubic-bezier(0.16, 1, 0.3, 1) 450ms"
              }}
            >
              <StartProjectButton
          ...
          <div className="lg:col-span-5 hidden lg:flex justify-center relative min-h-[460px] select-none">
            ...
            <svg 
              ...
              style={{
                ...
                transition: "opacity 1s ease 1300ms"
              }}
            >
            ...
            <div
              style={{
                transform: "translate(calc(var(--mx) * 5px), calc(var(--my) * 5px)) translateY(0px)",
                opacity: mounted ? 1 : 0,
                transition: "opacity 0.8s cubic-bezier(0.16, 1, 0.3, 1) 750ms, transform 0.8s cubic-bezier(0.16, 1, 0.3, 1) 750ms"
              }}
              className="absolute top-10 right-[15%] w-[160px] bg-slate-950/90 border border-slate-800 rounded-lg p-3 shadow-2xl z-30 font-mono text-[8px] text-slate-400 space-y-1.5"
            >
            ...
            <div 
              style={{
                ...
                opacity: mounted ? 1 : 0,
                transition: "opacity 0.8s cubic-bezier(0.16, 1, 0.3, 1) 900ms, transform 0.8s cubic-bezier(0.16, 1, 0.3, 1) 900ms"
              }}
              className="absolute top-6 left-[10%] w-[240px] bg-slate-950/80 border border-slate-800 rounded-xl p-4 shadow-2xl z-10 animate-float-slow"
            >
            ...
            <div 
              style={{
                ...
                opacity: mounted ? 1 : 0,
                transition: "opacity 0.8s cubic-bezier(0.16, 1, 0.3, 1) 1000ms, transform 0.8s cubic-bezier(0.16, 1, 0.3, 1) 1000ms"
              }}
              className="absolute top-[170px] left-[25%] w-[200px] bg-slate-950/90 border border-brand-500/30 rounded-xl p-4 shadow-2xl z-20 animate-pulse-glow"
            >
            ...
            <div 
              style={{
                ...
                opacity: mounted ? 1 : 0,
                transition: "opacity 0.8s cubic-bezier(0.16, 1, 0.3, 1) 1100ms, transform 0.8s cubic-bezier(0.16, 1, 0.3, 1) 1100ms"
              }}
              className="absolute bottom-6 left-[5%] w-[210px] bg-slate-950/80 border border-slate-800 rounded-xl p-4 shadow-2xl z-10"
            >
            ...
            <div 
              style={{
                ...
                opacity: mounted ? 1 : 0,
                transition: "opacity 0.8s cubic-bezier(0.16, 1, 0.3, 1) 1200ms, transform 0.8s cubic-bezier(0.16, 1, 0.3, 1) 1200ms"
              }}
              className="absolute bottom-[40px] right-[5%] w-[210px] bg-slate-950/85 border border-brand-500/20 rounded-xl p-4 shadow-2xl z-10"
            >
