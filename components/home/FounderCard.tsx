        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end w-full reveal-on-scroll">
            ...
            >
              ...
              <div className="relative bg-white dark:bg-[#0d1321] border border-slate-200 dark:border-slate-800 rounded-2xl shadow-premium overflow-hidden transition-all duration-500 hover:border-slate-350 dark:hover:border-slate-750 hover:-translate-y-1 hover:shadow-premium-hover">
                  ...
                  <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                      <pattern id="cardGrid" width="20" height="20" patternUnits="userSpaceOnUse">
                        <path d="M 20 0 L 0 0 0 20" fill="none" stroke="currentColor" className="text-slate-400 dark:text-slate-800" strokeWidth="0.5" />
                      </pattern>
                    </defs>
                ...
                <div className="p-8 flex flex-col items-center gap-5 text-center relative z-10">
                  ...
                  <div className="h-20 w-20 rounded-full bg-slate-900 dark:bg-slate-950 flex items-center justify-center text-white font-extrabold text-2xl shadow-md border-2 border-slate-800 dark:border-slate-700 relative group-hover:scale-105 transition-transform duration-500">
                    ST
                    {/* Ring indicator */}
                    <span className="absolute -bottom-1 -right-1 w-4 h-4 rounded-full bg-brand-500 border-2 border-white dark:border-[#0d1321] flex items-center justify-center">
                      <Terminal className="h-2.5 w-2.5 text-white" />
                    </span>
                  </div>

                  <div className="space-y-1">
                    <h4 className="font-extrabold text-navy-900 dark:text-slate-100 text-base">Sumit Tiwari</h4>
                    <p className="text-slate-500 dark:text-slate-400 text-xs font-mono tracking-wider flex items-center justify-center gap-1.5">
                      <GitBranch className="h-3.5 w-3.5 text-brand-500 dark:text-brand-400" />
                ...
                {/* Card Footer Link */}
                <div className="bg-slate-50/80 dark:bg-slate-900/60 border-t border-slate-100 dark:border-slate-800/60 px-6 py-4 flex items-center justify-between relative z-10">
                  <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Founder Profile</span>
                  <span className="text-xs font-bold text-brand-600 dark:text-brand-400 flex items-center gap-1 transition-colors group-hover:text-brand-500 dark:group-hover:text-brand-350">
