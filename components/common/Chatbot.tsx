...
export default function Chatbot({ isInline = false }: { isInline?: boolean }) {
 ...
 if (isInline) {
 return (
 <div className="flex flex-col bg-white border border-slate-200 rounded-2xl w-full h-[580px] overflow-hidden relative shadow-premium pointer-events-auto">
 {/* Header */}
 ...
 className="flex-1 text-sm bg-slate-50 border border-slate-200 rounded-lg px-3.5 py-2.5 text-slate-850 placeholder-slate-400 focus:outline-none focus:border-brand-500 focus:bg-white transition-premium disabled:bg-slate-100 disabled:text-slate-400 "
 />
 <button
 type="submit"
 disabled={
